...
import { fadeAnim } from '@styles/components/home/projects.module.scss'
    ...
    return (
        <div className={styles.welcomeSection}>
            ...
            <div className={styles.welcomeLine}>
                ...
                <div ref={arrowRef} className={`${styles.welcomeArrow} ${animating && fadeAnim}`} style={{opacity: animating ? 0 : 1}}>
