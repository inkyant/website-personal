...
export const projects = [
  {title: "Robotics",   
    ...
    top 8 alliance in the world (we had previously never even made it to championships). I led projects for autonomous path following
    on a swerve drivetrain, vision processing for robot position estimation, and nearly all programming on the team. I implemented industy
    standard code processes to help more people contribute to the team by creating a tasklist and following PR procedures with automatic 
    code tests and expert code reviews. I also created a curriculum to teach the new students various aspects of robotics, from electronics
    to control theory to autonomous movement and networks. I was also a part of the Curriculum Council making decisions on how to manage the
    50 student team.`, 
  ...
  {title: "Website",  
    ...
    for React development. I have had previous web development experience as a part of the Open Source Club, where in a small team we 
    created a website to run a mass chess game between two schools. This involved using mongo.db databases as well as google OAuth.`,
